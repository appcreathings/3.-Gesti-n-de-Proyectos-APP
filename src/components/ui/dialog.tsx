  ...
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "bottom-0 left-0 right-0 top-auto max-h-[99vh] rounded-t-xl sm:left-1/2 sm:top-1/2 sm:h-[99vh] sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-xl md:w-[85vw] md:max-w-5xl md:h-[99vh] lg:h-[99vh]",
        className,
      )}
      {...props}
    >
